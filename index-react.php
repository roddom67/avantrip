...
<html lang="es">
   ...
   <body>
      <div id="wrapper" className="staticPage flights-to hotels-to newYork">
         ...
         <main id="landscape">
            <div className="imagen-titulo"><img src="images/vuelos-a-nueva-york.jpg" alt="Vuelos y Hoteles a Nueva York" title="Vuelos y Hoteles a Nueva York" /></div>
            <div className="container">
                  		...
                  		<a href="">
                  			<div>
                  				...
                  				<div className="textAreaOferta">
                  					...
                  					<span className="stars"><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="fas fa-star"></i><i className="far fa-star"></i></span>
                  					<div className="priceArea">
                  						<small>Desde</small>
                  						<p>AR$ 5.961</p>
                  						<small className="before">Antes <span>AR$ 13.247</span></small>
                  					</div>
                  			...
                  			<div>
                  				...
                  				<div className="textAreaOferta">
                  					...
                  					<div className="priceArea">
                  						<small>Desde</small>
                  						<p>AR$ 4.850</p>
                  						<small className="before">Antes <span>AR$ 7.462</span></small>
                  					</div>
                  					<small>Habitación por noche</small>
                  					<h5>Ver Hotel</h5>
                  				</div>
